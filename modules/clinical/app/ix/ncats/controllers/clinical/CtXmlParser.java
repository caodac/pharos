...
public class CtXmlParser extends DefaultHandler {
    ...
    static final String RARE_DISEASE_URL = 
        "https://clinicaltrials.gov/ct2/search/browse?brwse=ord_alpha_all&brwse-force=true";
    ...
    public void startElement (String uri, String localName, 
        ...
        if (qName.equals("clinical_study")) {
            ...
            ct.eligibility = eli = new Eligibility ();
                 ...
                 || qName.equals("study_design_info"))
            ct.studyDesign = new StudyDesign ();
        else if (qName.equals("link")) {
            ct.properties.add(link = new Keyword ());
            link.label = "Link";
        }
    ...
    public void endElement (String uri, String localName, String qName) {
        ...
        if (value.length() == 0)
            ...
            ct.studyDesign.primaryPurpose = value;
        }
        ...
        else if (qName.equals("other_name")) {
            if (parent.equals("intervention")) {
                interv.synonyms.add
                    (new Keyword ("Clinical Intervention", value));
            }
        }
            ...
            ct.keywords.add(new Keyword ("Keyword", value));
        }
        else if (qName.equals("mesh_term")) {
            ct.keywords.add(new Keyword ("MeSH", value));
        }
        ...
        else if (qName.equals("study_first_submitted")) {
            ct.firstReceivedDate = parseDate (value);
        }
        else if (qName.equals("last_update_submitted")) {
        ...
        else if (qName.equals("results_first_submitted")) {
        ...
        else if (parent.equals("study_design_info")) {
            switch (qName) {
            case "allocation":
                ct.studyDesign.allocation = value;
                break;
            case "intervention_model":
                ct.studyDesign.interventionModel = value;
                break;
            case "primary_purpose":
                ct.studyDesign.primaryPurpose = value;
                break;
            case "masking":
                ct.studyDesign.masking = value;
                break;
            default:
                Logger.warn("Unknown child element of \""+parent+"\": "+qName);
            }
        }
