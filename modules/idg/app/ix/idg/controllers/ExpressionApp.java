...
public class ExpressionApp extends App {
    ...
    public static String getHomunculusXml (final String acc,
                                           final String source)
        throws Exception {
        final String key = ExpressionApp.class.getName()
            +"/homunculus/"+acc+"/"+source;
        return getOrElse (key, new Callable<String> () {
                public String call () throws Exception {
                    return _getHomunculusXml (acc, source);
                }
            });
    }
    ...
    public static Result homunculus (final String acc, final String source)
        throws Exception {
        if (acc == null)
